...
- (BTTx *)buildTxWithOutputs:(NSArray *)outs toAddresses:(NSArray *)addresses amounts:(NSArray *)amounts changeAddress:(NSString *)changeAddress dynamicFeeBase:(uint64_t)dynamicFeeBase isNoPrivKey:(BOOL)isNoPrivKey andError:(NSError **)error;
