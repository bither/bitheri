    ...
    if (sigBytes.length > 0) {
        ...
        if (self.tx.coin == BCC) {
            ...
            if (self.tx.isDetectBcc) {
                ...
                hash = [self.tx hashForSignatureWitness:self.index connectedScript:connectedScript type:[self.tx getSigHashType] prevValue:preOutValues[self.index] anyoneCanPay:false];
            } else {
